...
import { useGetAddressDetailQuery } from "../../services/address/addressAPI";
interface Person {
  id: number;
  name: string;
}
...
const EditAddressComponent: React.FunctionComponent<EditAddressProps> = ({
  citiesData,
  districtData,
  idCity,
  idDistrict,
  ...
  const { data: addressDetail } = useGetAddressDetailQuery(addressId);
                  ...
                  <div className="">
                    <div className="text-left mb-4">
                      ...
                      <input
                        ...
                        defaultValue={addressDetail?.city_id}
                      />
                    </div>
                    <div className="text-left mb-4">
                      <label
