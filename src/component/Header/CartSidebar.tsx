...
const CartSidebar: React.FunctionComponent<ChildProps> = ({ showCart, setshowCart, cartItem }) => {
    const handleClick = () => {
        ...
        <Transition.Root show={showCart} as={Fragment}>
            <Dialog as="div" className="relative z-[1010]" onClose={() => handleClick()}>
                ...
                <div className="fixed inset-0 overflow-hidden">
                    ...
                    <div key={item?.cart_id} className="absolute inset-0 overflow-hidden">
                                    ...
                                    <div className="mt-6 flex-1 px-4">
                                        <div className="sidebar-cart__item">
                                            ...
                                            <div className="sidebar-cart__item--img flex-shrink-0">
                                                <img className="" src={item?.image} alt="san phẩm" />
                                            </div>
                                            <div className="sidebar-cart__item--desc flex-grow-1">
                                                <div className="sidebar-cart__item--desc--title">{item?.book_name}</div>
                                                <div className="sidebar-cart__item--desc--attribute">Arthur c. brooks oprah winfrey</div>
                                                <div className="sidebar-cart__item--desc--quantity">Quantity: {item?.amount}</div>
                                            </div>
                                            <div className="sidebar-cart__item--price flex-shrink-0">
                                                <div className="sidebar-cart__item--price--new">${item?.price}</div>
                                                <div className="sidebar-cart__item--price--old">${item?.price}</div>
