...
const NotFound: React.FunctionComponent = () => {
    return (
        <div className="bg-[#FBF4EA] flex flex-col items-center py-[104px] px-3 mt-[76px]">
            ...
            <div>
                <Link to="/" className="px-6 py-3 uppercase rounded-xl border border-primary border-solid text-primary font-semibold ease-out duration-300 hover:text-white hover:border-orange-orange-6 hover:bg-orange-orange-6">Go Back To HomePage</Link>
            </div>
        </div>
    );
};
